...
public class Update_Profile extends HttpServlet {
    ...
    public void init() throws ServletException
    {
        ...
        (url+dbName,userName,password);
            ...
            stat.execute("SELECT * FROM users");
        }
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            String query = "UPDATE users SET first_name = ?, last_name = ?, mobile_number = ?, email_address = ?, password = ?, expertise = ? WHERE 1=1";
            ...
            response.sendRedirect("Edit_Profile_Success.html");
        }
