 ...
 * @author Wayne
 */
@WebServlet(name = "Add_CV", urlPatterns = {"/Add_CV"})
public class Add_CV extends HttpServlet {
    ...
    public void init() throws ServletException
    {
        ...
        (url+dbName,userName,password);
            ...
            stat.execute("CREATE TABLE IF NOT EXISTS resumes "
            + "(first_name CHAR(20), last_name CHAR(20), mobile_number VARCHAR(10), email_address VARCHAR(40), job1_title VARCHAR(30), years_worked1 VARCHAR(20), job1_salary VARCHAR(20), job2_title VARCHAR(30), years_worked2 VARCHAR(20), job2_salary VARCHAR(20))");
        }
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
            String query = "INSERT INTO resumes VALUES (?,?,?,?,?,?,?,?,?,?)";
