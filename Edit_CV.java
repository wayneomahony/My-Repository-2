 ...
 * @author student
 */
@WebServlet(name = "Edit_CV", urlPatterns = {"/Edit_CV"})
public class Edit_CV extends HttpServlet {
...
"        \n" +
"	<h2>\n" +
"		Edit your CV here to optimise it!\n" +
"	</h2>");
        ...
        try
        {
            ...
            String sql;
            sql = "SELECT first_name, last_name, mobile_number, email_address, job1_title, years_worked1, job1_salary, job2_title, years_worked2, job2_salary FROM resumes";
            ...
            while(rs.next())
            {
                ...
                String job1_title = rs.getString("job1_title");
                String years_worked1 = rs.getString("years_worked1");
                String job1_salary = rs.getString("job1_salary");
                String job2_title = rs.getString("job2_title");
                String years_worked2 = rs.getString("years_worked2");
                String job2_salary = rs.getString("job2_salary");
                //display values
                out.print("<form id=\"add_CV_form\" action=\"Update_CV\" method=\"POST\">\n" +
...
"            <br><br>\n" +
"                        Job1 Title: <input type=\"text\" name=\"job1_title\" value = " + job1_title + ">\n" +
"            <br><br>\n" +
"                        Years Worked: <input type=\"text\" name=\"years_worked1\" value = " + years_worked1 + ">\n" +
"            <br><br>\n" +
"                        Job1 Salary: <input type=\"text\" name=\"job1_salary\" value = " + job1_salary + ">\n" +
"            <br><br>\n" +
"                        Job2 Title: <input type=\"text\" name=\"job2_title\" value = " + job2_title + ">\n" +
"            <br><br>\n" +
"                        Years Worked: <input type=\"text\" name=\"years_worked2\" value = " + years_worked2 + ">\n" +
"            <br><br>\n" +
"                        Job2 Salary: <input type=\"text\" name=\"job2_salary\" value = " + job2_salary + ">\n" +
"            <br><br><br><br>\n" +
